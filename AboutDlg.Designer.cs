namespace Shenlong
{
	partial class AboutDlg
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelVersion.Text = "shenlong version 1.00.9999";
			// 
			// buttonOK
			// 
			this.buttonOK.Location = new System.Drawing.Point(107, 64);
			...
			this.linkLabel1.Text = "問い合わせ";
			this.toolTip.SetToolTip(this.linkLabel1, "開発担当者にメールで問い合わせる");
